...
export const chapters: Chapter[] = [
  {
    ...
    lead: "Перестаёшь писать «переформулируй» и собираешь своего ИИ-сотрудника, который продаёт за тебя 24/7.",
    outcomes: [
  ...
  },
  {
    ...
    lead: "Делаешь больше контента, чем команда из пяти. ИИ-аватар ведёт сторис, пока ты спишь.",
    outcomes: [
  ...
  },
  {
    ...
    lead: "Разговариваешь с кодом — и получаешь рабочий лендинг, приложение или агента под задачу.",
    outcomes: [
